...
# From BUILD_NOTES.txt
WITH_BF_OCIO = True
BF_OCIO = '/opt/lib/ocio'
BF_OPENEXR = '/opt/lib/openexr'
BF_OPENEXR_LIB = 'Half IlmImf Iex Imath '
BF_OPENEXR_LIB_STATIC = '${BF_OPENEXR}/lib/libHalf.so ${BF_OPENEXR}/lib/libIlmImf.so ${BF_OPENEXR}/lib/libIex.so ${BF_OPENEXR}/lib/libImath.so ${BF_OPENEXR}/lib/libIlmThread.so'
...
BF_FFMPEG_LIB = 'avformat avcodec swscale avutil avdevice theoradec theoraenc theora vorbis vorbisfile vorbisenc ogg xvidcore vpx mp3lame x264 openjpeg'
LLIBS = ["xml2", "expat"] + LLIBS
